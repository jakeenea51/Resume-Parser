...
def home():
    ...
    if 'p' in request.form and filePath != '' and len(keywords) > 0:
        ...
        scoreMessage = 'Score: ' + str(round(score*100, 2)) + '%'
    ...
    # render HTML
    return render_template('index.html', form=form, keywords=keywords, scoreMessage=scoreMessage, matchesMessage=matchesMessage, uploadResult=uploadResult, errorMessage=errorMessage)
